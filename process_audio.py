...
WHISPER_BEAM_SIZE = 6             # Качество распознавания (3-5). Больше = лучше, но медленнее
...
MERGE_MIN_DURATION = 0.4          # Минимальная длительность для объединения (секунды)
MERGE_MAX_GAP = 0.4               # Максимальный разрыв для объединения (секунды)
